    ...
    return(
        <main className="modal">
            ...
            <section className="conteudo">
                ...
                <div className="modals">
                    <img src={img4} alt="Guincho Pesado" />
                ...
                <div className="modals">
                    <img src={img6} alt="Guincho Plataforma" />
                ...
                <div className="modals">
                    <img src={img10} alt="Guincho para Veículos Especiais" />
                ...
                <div className="modals">
                    <img src={img1} alt="Guincho 24 Horas" />
                ...
                <div className="modals">
                    <img src={img9} alt="Guincho para Veículos 4x4" />
                ...
                <div className="modals">
                    <img src={img2} alt="Reboque para Concessionária" />
